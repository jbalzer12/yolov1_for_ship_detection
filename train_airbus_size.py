...
OUTPUT_FILE_NAME = 'airbus_135_resolution_448_S_14_0001_size'
RUN_LOCAL = False
...
if not(LOAD_MODEL) and not(CONTINUE_MODEL): 
    ...
    OUTPUT.write('Train_mAP_0_05 Test_mAP0_05 Train_mAP_0_1 Test_mAP_0_1 Train_mAP_0_2 Test_mAP_0_2 Train_mAP_5 Test_mAP_5 Train_mAP Test_mAP Mean_loss\n')
    OUTPUT.close()
...
def main():
    ...
    if not RUN_LOCAL:
        ...
        smaller_5_train_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_5_train.csv"
        smaller_5_test_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_5_test.csv"
        smaller_10_train_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_10_train.csv"
        smaller_10_test_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_10_test.csv"
        smaller_20_train_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_20_train.csv"
        smaller_20_test_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_20_test.csv"
        smaller_50_train_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_50_train.csv"
        smaller_50_test_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_50_test.csv"
        smaller_100_train_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_100_train.csv"
        smaller_100_test_csv = "/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_100_test.csv"
    else: 
        csv_directory_train = "data/airbus-ship-detection/train.csv"
        csv_directory_test = "data/airbus-ship-detection/val.csv"
        smaller_5_train_csv = "data/airbus-ship-detection/smaller_5_train.csv"
        smaller_5_test_csv = "data/airbus-ship-detection/smaller_5_test.csv"
        smaller_10_train_csv = "data/airbus-ship-detection/smaller_10_train.csv"
        smaller_10_test_csv = "data/airbus-ship-detection/smaller_10_test.csv"
        smaller_20_train_csv = "data/airbus-ship-detection/smaller_20_train.csv"
        smaller_20_test_csv = "data/airbus-ship-detection/smaller_20_test.csv"
        smaller_50_train_csv = "data/airbus-ship-detection/smaller_50_train.csv"
        smaller_50_test_csv = "data/airbus-ship-detection/smaller_50_test.csv"
        smaller_100_train_csv = "data/airbus-ship-detection/smaller_100_train.csv"
        smaller_100_test_csv = "data/airbus-ship-detection/smaller_100_test.csv"
    ...
    train_dataset_0_05 = Other_Dataset(
        smaller_5_train_csv,
        transform=transform,
        #transform=train_transforms,
        img_dir=IMG_DIR,
        #label_dir=LABEL_DIR,
        label_dir = '/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_5',
        S=S,
        B=B,
        C=num_classes,
    )
    test_dataset_0_05 = Other_Dataset(
        smaller_5_test_csv, 
        transform=transform, 
        #transform=test_transforms,
        img_dir=IMG_DIR, 
    ...
    train_dataset_0_1 = Other_Dataset(
        smaller_10_train_csv,
        transform=transform,
        #transform=train_transforms,
        img_dir=IMG_DIR,
        #label_dir=LABEL_DIR,
        label_dir = '/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_10',
        S=S,
        B=B,
        C=num_classes,
    )
    test_dataset_0_1 = Other_Dataset(
        smaller_10_test_csv, 
        transform=transform, 
        #transform=test_transforms,
        img_dir=IMG_DIR, 
    ...
    train_dataset_0_2 = Other_Dataset(
        smaller_20_train_csv,
        transform=transform,
        #transform=train_transforms,
        img_dir=IMG_DIR,
        #label_dir=LABEL_DIR,
        label_dir = '/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_20',
        S=S,
        B=B,
        C=num_classes,
    )
    test_dataset_0_2 = Other_Dataset(
        smaller_20_test_csv, 
        transform=transform, 
        #transform=test_transforms,
        img_dir=IMG_DIR, 
    ...
    train_dataset_0_5 = Other_Dataset(
        smaller_50_train_csv,
        transform=transform,
        #transform=train_transforms,
        img_dir=IMG_DIR,
        #label_dir=LABEL_DIR,
        label_dir = '/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_50',
        S=S,
        B=B,
        C=num_classes,
    )
    test_dataset_0_5 = Other_Dataset(
        smaller_50_test_csv, 
        transform=transform, 
        #transform=test_transforms,
        img_dir=IMG_DIR, 
    ...
    '''
    train_dataset_1 = Other_Dataset(
        smaller_100_train_csv,
        transform=transform,
        #transform=train_transforms,
        img_dir=IMG_DIR,
        #label_dir=LABEL_DIR,
        label_dir = '/scratch/tmp/jbalzer/data/airbus-ship-detection/smaller_100',
        S=S,
        B=B,
        C=num_classes,
    )
    
    test_dataset_1 = Other_Dataset(
    ...
    train_loader_0_1 = DataLoader(
        dataset=train_dataset_0_1,
        batch_size=BATCH_SIZE,
        num_workers=NUM_WORKERS,
        pin_memory=PIN_MEMORY,
        shuffle=True,
    ...
    test_loader_0_1 = DataLoader(
        dataset=test_dataset_0_1,
        batch_size=BATCH_SIZE,  
        num_workers=NUM_WORKERS,
        pin_memory=PIN_MEMORY,
        shuffle=True,
    ...
    for epoch in range(EPOCHS):
        ...
        train_loaders = [train_loader_0_05, train_loader_0_1, train_loader_0_2, train_loader_0_5] #, train_loader_1]
        sizes = [0.05, 0.1, 0.2, 0.5] #, 1]
        ...
        #es gibt keine label in 70 - 100 %. was tun?
        ...
        test_loaders = [test_loader_0_05, test_loader_0_1, test_loader_0_2, test_loader_0_5] #, test_loader_1]
        sizes = [0.05, 0.1, 0.2, 0.5] #, 1]
