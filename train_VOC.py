...
OUTPUT_FILE_NAME = 'VOC_500_augmentation_added'
#OUTPUT_FILE_NAME = 'VOC_500_dropout_added'
...
if not LOAD_MODEL and not CONTINUE_MODEL: 
    ...
    #OUTPUT.write('Train_mAP_0_05 amount Test_mAP0_05 amount Train_mAP_0_2 amount Test_mAP0_2 amount Train_mAP_0_5 amount Test_mAP_0_5 amount Train_mAP_1 amount Test_mAP_1 amount Test_mAP Mean_loss\n')
